  ...
  useEffect(() => {
    ...
    const handleStorageChange = (event: StorageEvent) => {
      if (event.key === 'page_news' || event.key === 'editor_news') {
        console.log('News page editor - Storage change detected');
        loadPageContent();
      }
    };
      ...
      <main className="flex-1 p-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <p className="text-gray-600 mb-6">
            {language === 'fr' 
              ? 'Modifiez le contenu de la page des actualités ci-dessous. Les modifications seront visibles sur le site après l\'enregistrement.'
